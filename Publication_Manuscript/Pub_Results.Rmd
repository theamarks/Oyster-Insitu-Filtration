...
# Filtration trials only - exclude Negative controls & Percent Chl removed less than 0
...
# with Filtration_pos_data serves both purposes. 
...
###  Domain knowledge - remove one single trial (NPD_2020_4_17) avg Chlup at sensor detection limit (+- 0.1 ug/L). Leave other extreme values.
test1 = test %>% 
...
```{r Langevin_SD_OlyDTW_SL}

SD_Oly_SL_DTW <- read_csv("./Data/Langevin_SD_O_lurida_length_weight_Theacopy.csv")
SD_Oly_SL_DTW %<>% 
...
SR_Oly_Shelllength_data = fread(file.path(Density_directory, "Insitu_Filter_SR_oyster_length.csv"))
