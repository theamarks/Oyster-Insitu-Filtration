...
x.seq = seq(min(Corr_chl_diff_data$correction_noabs),max(Corr_chl_diff_data$correction_noabs),by=.005)
...
model.temp = lm(filter_chl_diff~correction_noabs,data=Corr_chl_diff_data1)
x.seq = seq(min(Corr_chl_diff_data1$correction_noabs),max(Corr_chl_diff_data1$correction_noabs),by=.005)
y.seq = predict(model.temp,newdata=data.frame(correction_noabs=x.seq),interval="prediction",level=.98)
low.bound = y.seq[,2]
high.bound = y.seq[,3]
