...
#colnames(Final_table) <- c("", "Site", "Date", "Experiment", "Temp ($\textdegree$C)","Salinity (ppt)", "Turbidity (NTU)", "TPM ($\\mu$g/L)", 
 #                          "OC", "Chl $\\alpha$ up ($\\mu$g/L)", "Chl $\\alpha$ down ($\\mu$g/L)", 
  #                         "Depth (m)", "Water veolcity (m/hr)", "% Chl $\\alpha$ removal", "Clearance rate (L/hr/$m^2$)")

# create xtable
sumtable_side_LaTex <- xtable(Final_table, caption = "Summary Table of all field days")
# print LaTex code for sideways table
print.xtable(sumtable_side_LaTex,sanitize.text.function=function(x){x})
...
Table_LaTeX <- xtable(df, caption = "Summary table of all field days")
# print LaTex code for sideways table
