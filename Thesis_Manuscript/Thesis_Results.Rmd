...
Control trials measured `r round(SR_NC_sum$L_hr_m2,1)`, and `r round(MB_NC_sum$L_hr_m2,1)` Lhr^-1^m^2^ for San Rafael, Morro Bay respectively, Shellmaker's control trial was removed from the analysis as an extreme value \ref{Corr_to_signal_95CI_graph}.
...
aov.xt <- xtable(aov.model,
                       caption = 'Table 2: One-way ANOVA of the effect of site on habitat clearance rate (HCR, L hr hr\\textsuperscript{-1} m\\textsuperscript{-2}')
