...
gg_qplot <- ggplot(Filtration_only_data, aes(Temp_C_Up, L_hr_m2)) +
  geom_point() +
  geom_quantile(quantiles = q1)
gg_qplot 

# Simulaneous quantile regression
HCR_rq <- rq(L_hr_m2 ~ Temp_C_Up + Sal_ppt_Up + Turbidity_NTU_Up + Avg_TPM_mg_L + Avg_OC_Ratio + Site,
