...
Direct biomass data was only available for Deanza, which estimated `r round(NPD_total_DTW, 3)` g/m^2^ of bivalve dry tissue weight (DTW). 
...
San Rafael survey data did not directly assess biomass, but did include shell length measurements which was used to estimate DTW of *O. lurida* (`r round(SR_total_DTW,3)` g/m^2^) from the Deanza shell length:DTW model (model equation here). 
