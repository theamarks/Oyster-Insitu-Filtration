...
Three extreme observations were removed from the data set based on the signal-to-correction comparison (Figure \ref{Corr_to_signal_95CI_graph}).
One of three extreme values eliminated corresponded with a Chl $\alpha$ concentration near the sensor's detection limits (± 0.1 \\mu/L), the other two extreme values correspond with low Chl $\alpha$ concentrations (Table 1).
