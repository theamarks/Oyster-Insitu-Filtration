...
Sal_box <- ggplot(site_data_outrmd, aes(Site, Sal_ppt_Up)) +
  ...
  annotate("text", "San Rafael", 
           max((site_data_outrmd %>% 
                  filter(Site == "San Rafael"))$Sal_ppt_Up) + 1, label = "a") +
...
```{r TPM_OC_graphs, echo=FALSE, fig.align="center", fig.asp=0.618, fig.cap="The, fig.keep='all', fig.width=6, message=FALSE, warning=FALSE, dev='pdf', out.width="70%"}
