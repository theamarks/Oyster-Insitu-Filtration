...
Newport Shellmaker ranged from `r format(round(min(NPSM_filter_sum$L_hr_m2)), nsmall =1)` to `r round(max(NPSM_filter_sum$L_hr_m2),1)` Lhr^-1^m^2^.
Newport Deanza ranged from `r format(round(min(NPD_filter_sum$L_hr_m2)), nsmall =1)` to `r round(max(NPD_filter_sum$L_hr_m2),1)` Lhr^-1^m^2^.
