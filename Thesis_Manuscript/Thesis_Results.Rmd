...
out_HCR_test <- Filtration_only_data %>% 
  mutate(outlier = find_outlier(L_hr_m2))
```
...
Filtration trials across sites were not distributed equally (Table 1), Deanza had more than twice the amount filtratrion trials (*N* = 9) as San Rafael (*N* = 4), Morro Bay (*N* = 4), and Shellmaker (*N* = 4).
Each of the four sites had a single control.
Water quality conditions varied among bays 
