...
```{r NPD_Bivalve_SH_DTW_outrmd, echo=FALSE, include = F, fig.align="center", fig.asp=0.618, fig.cap="The biomass of bivalves excavated from Deanza in Newport Bay \\label{NPD_Bivalve_SH_DTW_outrmd}", fig.keep='all', fig.width=8.6, dev='pdf', out.width="100%"}
###### Not included ######### 
