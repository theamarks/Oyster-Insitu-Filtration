...
HCR for filtration trials did not differ significantly among sites (one-way ANOVA, (*F*(`r HCR_aov_values[[1,2]]`, `r HCR_aov_values[[2,2]]`) = `r round(HCR_aov_values[[1,5]],2)`, *p* = `r round(HCR_aov_values[[1,6]],2)`).
