...
knitr::opts_chunk$set(fig.path = "./Thesis_Manuscript/Figures", echo = FALSE, cache=TRUE, fig.asp=0.618, fig.align = "center")
```
...
```{r NPD_FRPos_TPM_graph, echo=FALSE, fig.keep = 'all', dev = 'pdf', fig.align="default", fig.asp=0.618, fig.show="hold", fig.width=4.3, out.width="50%", fig.cap="The positive habitat level filtration rates in response to seston total particulate matter (TPM) at the Deanza site in Newport Bay, California. \\label{figurelabel}"}
...
```{r TPM_OC_graphs, echo=FALSE, fig.keep = 'all', dev = 'pdf', fig.align="center", fig.asp=0.618, fig.show="hold", fig.width=6, out.width = "70%", fig.cap="The relationship between seston total particulate matter (TPM) and seston organic content (OC) across all sites and all filtration and negative control trials. \\label{figurelabel}"}
...
```{r TPM_OC_Sites_graphs, echo=FALSE, fig.keep = 'all', dev = 'pdf', fig.align="default", fig.asp=0.618, fig.show="hold", fig.width=8, fig.cap="The relationship between seston total particulate matter (TPM) and seston organic content (OC) across all sites and all trials. \\label{figurelabel}"}
...
```{r Oly_DTW_SH_outlier_rmd, echo=FALSE, fig.keep = 'all', dev = 'pdf', fig.align="center", out.width = "70%", fig.asp=0.618, fig.show="hold", fig.width=6, fig.cap="The relationship between *O. lurida* shell length and its dry tissue weight (DTW) in Newport Bay, California at the Deanza restoration site. Outlier data (outside mean +- 2.2 SD) and negative values are excluded. \\label{figurelabel}"}
...
```{r Linear_model_DTW_length, fig.height=6, fig.width=6, cache=TRUE, include=FALSE}
Oly_DTW_lm <- lm(data = NPD_oly_outRmd, tissue_dry_weight_g ~ length_mm)

ols_regress(Oly_DTW_lm)

coef(Oly_DTW_lm)
Oly_DTW_SL_formula <- function(length_mm) {length_mm + coef(Oly_DTW_lm)[,1]}
```

```{r Oly_DTW_SH_out_rmd_Trans, echo=FALSE, fig.keep = 'all', dev = 'pdf', fig.align="default", fig.asp=0.618, fig.show="hold", fig.width=8, fig.cap="The relationship between *O. lurida* shell length and its dry tissue weight (DTW) in Newport Bay, California at the Deanza restoration site. Possible transformations. \\label{figurelabel}"}
...
```{r Oly_TWW_DTW_outRmd, echo=FALSE, fig.keep = 'all', dev = 'pdf', fig.align="default", fig.asp=0.618, fig.show="hold", fig.width=8, fig.cap="The relationship between *O. lurida* total wet weight (TWW) and its dry tissue weight (DTW) in Newport Bay, California at the Deanza restoration site. Blue dashed lines represent the relationship found by Gray and Langdon (2018) in Yaquina Bay, Oregon Olympia oysters (DTW = 0.0044*TWW - 0.043) \\label{figurelabel}"}
...
```{r NPD_Bivalve_SH_DTW, fig.keep = 'all', dev = 'pdf', fig.align="center", out.width = "100%", fig.asp=0.618, fig.show="hold", fig.width=8.6, fig.cap="The biomass of bivalves excavated from Deanza in Newport Bay, California. Raw data. \\label{figurelabel}"}
...
```{r NPD_Bivalve_SH_DTW_outrmd, fig.keep = 'all', dev = 'pdf', fig.align="center", out.width = "100%", fig.asp=0.618, fig.show="hold", fig.width=8.6, fig.cap="The biomass of bivalves excavated from Deanza in Newport Bay, California. Negative and outliers removed (+- 2.2 SD). \\label{figurelabel}"}
# Remove outlier and negative DTW value
...
```{r Bivalve_Density, fig.keep = 'all', dev = 'pdf', fig.align="center", out.width="70%", fig.asp=0.618, fig.show="hold", fig.width=6, fig.cap="The density of bivalves by species across sites. \\label{figurelabel}"}
...
```{r Bivlave_biomass_sites, fig.keep = 'all', dev = 'pdf', fig.align="center", out.width="70%", fig.asp=0.618, fig.show="hold", fig.width=6, fig.cap="The biomass of bivalves by species across Olympia oyster restoration sites. \\label{figurelabel}"}
...
```{r Bar_Graphs_up_vs_down, cache=TRUE, include=FALSE}
...
```{r Bar_Graphs_up_vs_down_grid.arrange, fig.keep = 'all', dev = 'pdf', out.width = "100%", fig.align="default", fig.asp=0.75, fig.show="hold", fig.width=8.6, fig.cap="Chlorphyll concentrations measured at upstream and downstream instruments across all sites, filtration trials, and negative controls. \\label{figurelabel}"}
...
```{r LM_PrctChl_pos_add, eval=FALSE, fig.height=5, fig.width=6, cache=TRUE, include=FALSE}
...
```{r eval=FALSE, fig.height=5, fig.width=6, cache=TRUE, include=FALSE}
...
```{r eval=FALSE, fig.height=10, fig.width=6, cache=TRUE, include=FALSE}
#Positive Filtration ~ ChlRmd Multiple Regression with selected variables
# detailed multiple regression summary - ANOVA results
ols_regress(LM2_PrctChl_pos_add)
```

```{r LM_FR_pos, eval=FALSE, cache=TRUE, include=FALSE}
