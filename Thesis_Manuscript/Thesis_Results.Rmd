...
knitr::opts_chunk$set(fig.path = "./Thesis_Manuscript/Figures", 
                      root.dir = normalizePath('../'), # set working directory to one set below thesis folder
                      echo = FALSE, cache=TRUE, fig.asp=0.618, fig.align = "center")
```
