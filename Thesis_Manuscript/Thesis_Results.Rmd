...
generate_label_df <- function(HSD, flev, d){
 ...
 # upper quantile and label placement
    boxplot.df <- plyr::ddply(d, flev, function (x) max(fivenum(x$y)) + 0.2)
...
Chl_box <- ggplot(site_data_outrmd, aes(Site, Chl_ug_L_Up)) +
  ...
  geom_text(data = generate_label_df(tukey_chl, 'Site', Chl_ug_L_Up), 
