...
*O. lurida* had the highest DTW with `r SR_species_DTW[SR_species_DTW$Species=="Ostrea lurida",2]` g/m^2^, followed by *Mytilus galloprovincialis* (`r SR_species_DTW[SR_species_DTW$Species=="Mytilus galloprovincialis",2]` g/m^2^), an unknown mussel (`r SR_species_DTW[SR_species_DTW$Species=="Unknown mussel",2]` g/m^2^), *Adula diegensis* (`r SR_species_DTW[SR_species_DTW$Species=="Adula diegensis",2]` g/m^2^), and *Musculista senhousia* (`r SR_species_DTW[SR_species_DTW$Species=="Musculista senhousia",2]` g/m^2^).
