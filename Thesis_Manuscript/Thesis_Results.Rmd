...
knitr::opts_chunk$set(fig.path = "./Thesis_Manuscript/Figures", include=FALSE, cache=TRUE)
```
...
```{r Figure_FR_CHLRmd_Site_boxplot, fig.align="default", fig.width=4.3, fig.asp=0.618, out.width="50%", fig.show="hold"}
FR_box
Chl_Rmd_box
```
