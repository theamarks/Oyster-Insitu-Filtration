...
y.adj = res + mean(test1$Clearance) # I don't understand adding residuals and mean(Clearance) - AM 
...
model.rf.filter$importance[order(model.rf.filter$importance)] # trying to order variable importance in decending order
