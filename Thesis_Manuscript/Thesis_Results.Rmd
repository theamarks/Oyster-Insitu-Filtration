...
Three filtraiton trials at San Rafael recorded significantly lower Chl $\alpha$ downstream of the *O. lurida* shell bags than Chl $\alpha$ upstream ( Table X).
One filtration trial (2018/7/17) and the negative control did not show a significant difference reduction of Chl $\alpha$ over the habitat from the upstream to downstream positions. 
