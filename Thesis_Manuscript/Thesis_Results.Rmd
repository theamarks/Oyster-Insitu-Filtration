...
A power analysis of this one-way ANOVA determined that effect size between site and \% Chl $\alpha$ is very small (*ES* = `r format(round(Chlrmd_site_power$f, 2), nsmall = 2)`) [@Sawilowsky2009] with little statistical power (`r round(Chlrmd_site_power$power,2)`).
