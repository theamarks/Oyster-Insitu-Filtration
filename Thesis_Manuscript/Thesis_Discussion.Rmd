...
The field measurements I measured show HCRs are highly variable at each site.
These findings suggest that the clearance rate differences between *O. lurida* and *C. gigas* are less important in estimating ecosystem filtration functions of *O. lurida* restoration and *C. gigas* aquaculture than considering *O. lurida* as a foundation species that realistically filters alongside other bivalves in dynamic environmental conditions. 
...
Olympia oysters are smaller and less robust filter-feeders than Pacific oysters [@Gray2018; @ZuErmgassen2013c].
@Gray2018 found that maximum clearance rates of *C. gigas* are almost twice that of *O. lurida* under laboratory conditions. 
These physiological differences have called into question to filtration functions that restored Olympia oyster habitat can provide to Pacific coast bays and estuaries [@ZuErmgassen2013c].
In contrast, the spatial-explicit hydrodynamic model in @Gray2019a, *O. lurida*'s filtration function could be an order of magnitude larger than estimated by @Gray2018's single-species model depending seasonal and hydrodynamics of the system.
Clearance rates are typically adjusted by grams of dry tissue weight (DTW), consequently a direct comparison between these results and my measured HCRs is only possible at the two sites with biomass estimates (Deanza and San Rafael) where I can clearance rates by biomass (DTW).
@Gray2018 measured *O. lurida* clearance rates averaging 0.78 L h^-1^g^-1^ in the dry season and 0.19 L h^-1^g^-1^ in the wet season in Yaquina Bay, OR, whereas *C. gigas* averaged 0.95 L h^-1^g^-1^ in the dry season and 1.06 L h^-1^g^-1^ in the wet season in the same location.
@Wheat2013 found that *C. gigas* grown on long-lines in Willipa Bay, WA cleared 0.73 L h^-1^g^-1^ ( 0.24 SE).
According to the all-season model produced from these measurements and the biomass of *O. lurida* at Deanza (1.36 gDTW m^-2^), HCR should be 1.13 L hr^-1^m^-2^ with average OC and temperature from Deanza field days.
...
Two important points emerge from the difference between these estimates: 1) Filtration function estimates need to incorporate the contributions of other bivalve filter-feeder, otherwise estimates may be massively underestimated; 2) Using the model derived from Yaquina Bay oysters and field conditions may not represent environmental conditions in California habitats, and local measurements are needed to estimate filtration functions.
...
Future studies will benefit from a suite of models that predict bivalve species-specific biomass from shell length measurements, allowing monitoring efforts to measure bivalve shell length without disturbing the habitat to estimate habitat filter feeders.
...
Allometric relationships may vary regionally [@Ross2006], and more studies are need from other locations.

As previously mentioned, @Gray2018's *O. lurida* in situ clearance rate model was conducted in a flow-through chamber and may not be directly applicable in estimating oyster habitat filtration functions without incorporating hydrodynmaics [@Gray2019a].
...
Turbulent flow within the boundary layer increases interaction and mixing with the larger water current, thus particle flux [@Muschenheim1987], and is generally characteristic of natural water bodies even in low velocity scenarios [@Sanford1997].
My measurements show negative HCRs at each site (Figure 3); a result of higher chl $\alpha$ at the downstream instrument than chl $\alpha$ at the upstream instrument.
This indicates that sediments were re-suspended over the habitat, and does not necessarily indicate a lack of filter-feeding, but that the signal was clouded by the net sediment transport. 
High water velocity can re-suspend sediments; @Dame1985 found that water velocity above 15 cm/s resuspended particles in a flume, and @Widdows1998 found that in high density mussel beds water velocity above 20-25 cm/s started to errod sediments.
My water velocity measurements ranged from 2-20 cm/s (Table 1), but velocities 15 cm/s and higher did not coorelate with negative HCR values. 
Negative HCRs could be further reasoned that smaller, lighter, organic materials measured by chl $\alpha$ sensors are resuspended at lower water velocities than sediments [see @Muschenheim1987].
...
@Milbrandt2015 used similar upstream-downstream insitu methods on restored bivalve bed in Florida and reported a range of habitat clearance rates from -26 to 157 L hr^-1^m^-2^.
...
They suggest that restored *O. lurida* and *C. gigas* long-line aquaculture in California may clear similar amounts of water per unit area when compared in realistic biological and environmental conditions.
...
Furthermore, overall filtration functions of *O. lurida* habitat may continue to be underestimated, unless a whole-habitat perspective is taken and future filtration function continue to incorporate the filtration contributions of other filter-feeders residing on foundational oyster habitat.
*O. lurida* restoration efforts on the North American west coast aim to increase abundances of this foundation species and its proported filtration functions. 
My research represents the first direct measurements of restored *O. lurida* habitat filtration functions, although highly variable, it shows that restored *O. lurida* habitat is a valuable contributor to filtration functions within California bays.


## Quesitons for DZ

* Future directions? 
  + Talk about adding spatial component @Gizzle2018 or @Gray2019a?
