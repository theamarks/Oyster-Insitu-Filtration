...
Although my study only includes a single *C. gigas* aquaculture site, the use of three *O. lurida* restoration sites in two bays north and south of Morro Bay set up a comparison with fairly robust inferential strength, albeit limited to the partiular contexts of the selected sites.
While my evidence is generated from limited data, the power analysis of HCR by site further points to a very small effect size and corroborates my findings that at least this particular *C. gigas* aquaculture setup does not "stand out" from *O. lurida* restoration.
