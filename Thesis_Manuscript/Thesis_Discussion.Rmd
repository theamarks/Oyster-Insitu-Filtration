...
The goal of this paper was to characterize the filtration functions of several types of constructed oyster habitat in California using in situ methods to incorporate whole-habitat and environmental effects. 
More precice methods of measuring bivalve filtration exsist (e.g. flume studies @Harsh1999, biodeposition, particle clearance), but they compromise the ability to incorporate the dynamic environmental and biological conditions that exsist in actual oyster habitats. 
...
First, we assumed that the water flowed linearly from the upstream insturment to the downstream instrument, thus both instruments are measuring the same uninterupted mass of water. 
Before taking any data, we observed and characterized the water dynamics at each site using Rhodamine WT. 
...
However, Rhodamine WT floureces in the wavelength range that the chl $\alpha$ sensors detect, so we could not use Rhodamine WT traces to check the water flow during experimental trials, and we had to be sure pre-experiment Rhodamine WT traces completely cleared the study area. 
Second, we assumed that water depth and velocity remained constant through the trial and habitat. 
Both depth and velocity were measured several times through out trials and averaged for calculation simplicity. 
...
Water dynamics in shallow estuaries often mixes water column "eliminating stratification of chlorophyll (Holligan et al. 1984 cited in @Judge1993), providing consistently suspended food to bivalve filter feeders [Officer 1982 & Fredett 1989 in @@Harsh1999; olligan et al. 1984 cited in @Judge1993] and eliminates possible food depletion to downstream animals. 
Fluid dynamics are highly complex, and can vary along the depth profile and across oyster habitat. 
Texture of habitat leads to varied hydrodynamics and particle redistribution in the water column (Harsh & Luckenback 1999)
