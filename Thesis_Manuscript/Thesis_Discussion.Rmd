...
*O. lurida* are smaller and less robust filter-feeders per unit biomass than *C. gigas* [@Gray2018; @ZuErmgassen2013c].
...
In contrast, in the spatially-explicit hydrodynamic model in @Gray2019a, *O. lurida*'s filtration function could be an order of magnitude larger than estimated by @Gray2018's single-species model depending upon seasonality and hydrodynamics in Yaquina Bay, Oregon.
...
@Gray2018 measured *O. lurida* clearance rates that averaged 0.78 L hr^-1^g^-1^ in the dry season and 0.19 L hr^-1^g^-1^ in the wet season in Yaquina Bay, OR. 
*C. gigas* averaged 0.95 L hr^-1^g^-1^ in the dry season and 1.06 L hr^-1^g^-1^ in the wet season in the same location, whereas @Wheat2013 found that *C. gigas* grown on long-lines in Willipa Bay, WA cleared 0.73 L hr^-1^g^-1^ (0.24 SE).
According to Gray & Langdon's [-@Gray2018] all-season model and the biomass of *O. lurida* at Deanza (1.36 g DTW m^-2^), Deanza's HCR should be 1.13 L hr^-1^m^-2^ using average OC and temperature from Deanza trials.
...
The in situ upstream-downstream method employed in my study inherently included natural hydrodynamic conditions formed from the interaction between the physical characteristics of oyster habitat and water flow dynamics that dictate food availability and quality to filter-feeders.
...
My measurements show at least one negative HCR trial at each site (Figure \ref{FR_Site_boxplot}); a result of higher Chl $\alpha$ concentrations downstream than Chl $\alpha$ concentrations upstream.
This likely indicates that sediments were re-suspended over the habitat, and does not necessarily suggest a lack of filter-feeding, but instead that the filter-feeding signal was clouded by the net sediment transport [Grizzle2008; @Wheat2013]. 
...
Negative HCRs may also result because smaller, lighter, organic materials are re-suspended at lower water velocities than inorganic sediments [see @Muschenheim1987; @Wheat2013], and measured by Chl $\alpha$ sensors.
...
This floating action may have disturbed bottom sediments, diluting the filtration signal, and created a 'moving target' for the water quality sondes.
The water quality sensors were positioned at the height of the bivalves, but at Morro Bay this height gradually increased with the flood tide, and may have partly missed the filtration signal creating a lower HCR than expected for *C. gigas* aquaculture.
Floating or off-bottom *C. gigas* aquaculture may not provide the same biochemical filtration function as *O. lurida* beds because, depending on the water depth, biodeposits are not always deposited on the sediment surface and made available to other benthic organisms; although this filtration function is not directly quantified through HCRs.
...
Considering the extremely low *O. lurida* biomass at San Rafael compared to Deanza, one would not expect San Rafael to have a similar range of HCRs (Table 1, 2). 
This similarity may be an artifact of the patchy and high relief habitat at San Rafael creating sediment seston sinks on the leeward side of the reef structures.
...
Forty percent of my trials far exceed their largest value (Table 1).
...
In addition, HCR variation could be the result of measuring hundreds and even thousands of bivalves (Figure \ref{Bivalve_Den_Biomass}). 
...
I found that temperature was the most important parameter (23%) in predicting HCRs with my random forest model (*R*^2^ = 0.64), aligning with previous bivalve feeding studies.
...
After temperature, variables relating to seston quantity and quality were reasonably important in predicting HCRs (turbidity 21.5%, TPM 21.2%, and OC 13.2%), also aligning with previous research [@Gray2018; @Moody2020a; reviewed in @Cranford2011]

## Conclusions

My results provide the first snapshot habitat clearance rates of oyster habitats in California, and shows that in situ upstream-downstream methods can detect filtration signals in this application.
Restored *O. lurida* habitat and *C. gigas* long-line aquaculture in California may clear similar amounts of water per unit area when compared in realistic biological and environmental conditions.
...
*O. lurida* restoration efforts on the North American Pacific coast aim to increase abundances of this foundation species and its purported filtration functions. 
...
*C. gigas* now accounts for the overwhelming majority of commercial oyster harvest on the North American west coast (need citation), and has established feral populations outside of aquaculture operations in the Salish Sea [@Quayle1988;], Willapa Bay, WA [@Kincaid1968], and Southern California [@Crooks2015a; @Polson2009; @Tronske2018].
...
*C. gigas* is a faster growing and larger oyster than *O. lurida* with a higher filtration rate [@Bougrier1995; @ZuErmgassen2013c; @Gray2018; @Gray2019] that is documented to decrease chlorophyll concentrations in Willapa Bay, WA [@Wheat2013].
