...
As preciously mentions, @Gray2018's *O. lurida* in situ clearance rate model was conducted in a flow-through chamber and may not be directly applicable in estimating oyster habitat filtration functions without incorporating hydrodynmaics [@Gray2019a].
...
***Paragraph about depth and negative values***

Water depth and flow velocity constrained my field days and deployment duration, resulting in filtration function snapshots.
...
### Save for high variability seciton
...
estimating filtration functions with a whole-habitat perspective is emmensly important
