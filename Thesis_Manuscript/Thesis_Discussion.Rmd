...
My field measurements also showed that HCRs are highly variable at each site.
...
Two important points emerge from the difference between these estimates: 1) Filtration function estimates need to incorporate the contributions of other bivalve filter-feeders, otherwise estimates may be massively underestimated; 2) Using the model derived from Yaquina Bay, OR oysters and field conditions may not represent environmental conditions in California bays, and this underscores the need for local measurements in order to accurately estimate filtration functions.
...
The in situ upstream-downstream method employed in my study inherently included natural hydrodynamic conditions formed by the interaction between the physical characteristics of oyster habitat and water flow dynamics that dictate food availability and quality to filter-feeders.
...
This likely indicates that sediments were re-suspended over the habitat, and does not necessarily suggest a lack of filter-feeding, but instead that the filter-feeding signal was clouded by the net sediment transport [Grizzle2008; @Wheat2013; @Milbrandt2015]. 
...
Although my measurements do not represent a comprehensive picture of filtration function across tidal and hydrodynamic conditions, they do represent filtration function at similar tidal and hydrodynamic conditions within each site (e.g. tide, depth, velocity in Table 1).
...
This similarity may be an artifact of the patchy and high relief habitat at San Rafael creating seston sinks on the leeward side of the reef structures.
...
Forty percent of my trials exceed their largest value (Table 1).
@Jones2011a found the HCRs of infaunal cockles in New Zealand to be between 20 and 420 L hr^-1^m^-2^, where 8\% of my HCR values exceed these values (Table 1).
...
In addition, HCR variation could be the result of measuring hundreds to thousands of bivalves (Figure \ref{Bivalve_Den_Biomass}). 
