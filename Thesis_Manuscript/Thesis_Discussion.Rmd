...
In this paper, I presented a highly predictive allometric model to estimate *O. lurida* biomass from shell length based on data from Newport Bay, CA (Figure 6) that can be used in future southern California studies.
Allometric relationships may vary regionally [@Ross2006], and more studies are need from other locations.

As previously mentioned, @Gray2018's *O. lurida* in situ clearance rate model was conducted in a flow-through chamber and may not be directly applicable in estimating oyster habitat filtration functions without incorporating hydrodynamics [@Gray2019a].
...
Negative HCRs could be further reasoned that smaller, lighter, organic materials measured by chl $\alpha$ sensors are re-suspended at lower water velocities than sediments [see @Muschenheim1987].
...
Furthermore, overall filtration functions of *O. lurida* habitat may continue to be underestimated, unless a whole-habitat perspective is taken and future filtration function continue to incorporate the filtration contributions of other filter-feeders residing on foundation oyster habitat.
