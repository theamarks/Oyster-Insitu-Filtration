...
All data wrangling and analysis were made in R 3.6.3 [@R], the graphs built in ggplot2 package [Wickham2016], and the code is publicly available on Github [@Marks2020].
...
Next, I examined the signal-to-correction relationship between the Chl $\alpha$ difference in side-by-side trials compared to the corresponding experiment Chl $\alpha$ difference [tidyverse R package @Wickham2019].
...
Next, to examine the relationship of water quality variables and site on HCR, I fitted a second Random Forest regression with only filtration trials [randomForest R package @Liaw2002].
