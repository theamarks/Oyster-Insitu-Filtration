...
The oysters grown in the bags are approximately five to 8 cm in length.
...
The effect of site on filtration trial HCR was examined using a one-way ANOVA. 
Another one-way ANOVA examined the top 0.5 quartile of data at each site to determine if the top HCR performance differed between and among sites. 
