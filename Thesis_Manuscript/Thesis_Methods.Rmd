...
All data wrangling and analysis were made in R 3.6.3 [@R] and the graphs built in the ggplot2 package [Wickham2016]; the code is publicly available on Github [@Marks2020].
