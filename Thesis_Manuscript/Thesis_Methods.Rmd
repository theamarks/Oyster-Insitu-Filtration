...
Another Kruskal-Wallis analysis examined the top 0.5 quartile of data at each site to determine if the top HCR performance differed among sites. 
A quartile analysis ($\tau$ = 0.5, 0.9) was used to see if water quality variables had differential relationships with HCR.
