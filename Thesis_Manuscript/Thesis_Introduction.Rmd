...
During the in situ trials individual oyster were placed in a flow through chamber filled with ambient seawater at a rate of 150-200 ml min^-1^, and individuals not filtering (closed valve) were excluded from the analysis [see @Cranford2011].
The models from this study provides important insights into *O. lurida* and *C. gigas* individual's feeding responses to specific conditions (temperature, salinity, turbidity, chlorophyll $\alpha$, Total Suspended Solids (TSS), and Organic Content (OC)) but are unable to fully replicate conditions of the natural environment/habitat [@Cranford2011].
...
The composition of this filer-feeding guild is likely to change across *O. lurida*'s distrubution, thus creating unique filtraiton signatures for different *O. lurida* habitat.

The amount and quality of suspended particles (seston) available to filter-feeders is well documented to affect their feeding behavior [citations].
Seston is made up of... [citations]
Availability of seston to filter-feeders change spatially and temporally from water flow dynamics from tides, winds, bathometric features and their interactions.
