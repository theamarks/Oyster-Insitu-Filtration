...
Restoring filtration functions is a component of the impetus behind native *O. lurida* restoration and living shoreline projects efforts along the West Coast, in concert with habitat provision and sediment stabalization [@Dinnel2009; @Henderson2015b; @Latta2015; @Wasson2015; @Zacherl2015a].
*O. lurida* restoration often occcurs on mudflats that have their own filtration functions driven by epibenthic bivalves.
...
For instance, *C. gigas* has a higher partical capture efficiency presumably because of its smaller gill ostea than *O. lurida* [@Elsey1935; @Gray2018; @Gray2016].
In addition, depending on the *C. gigas* aquaculture opperation, aquculture is maintained as a monoculture, whereas *O. lurida* habitat recruits other bivavle filter feeders, possibly providing aggregate filtration funcitons.
...
Next, individual bivalve feeding variation is aggregated with a higher precision in *in situ* measurements than filtration rates derived from individual bivlave feeding trials [@Jones2011a; @Iglesias1998; @Cranford2011].
