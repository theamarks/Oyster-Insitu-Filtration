...
Studies that exclude individuals that are not filtering (closed valves) artificially inflate filtration models and overestimate filtration when extrapolated to the population level [@Cranford2011; @Harsh1999]; this may partly explain why many field studies find lower filtration rates than laboratory studies [@Newell2005; @Grizzle2008; @Cranford2011]. 
...
Whereas the direct effects of water velocity on bivalve filter-feeding is unclear [@Grizzle1992; @Cranford1998; also see review in @Judge1992], water depth and velocity affect water column mixing and sediment re-suspension [@Widdows1998], and thus, food availability for benthic filter-feeders.
