...
*O. lurida* is concidered a foundation species [*sensu* @Dayton1972] in estuarine ecosystems because of the complex biogenic habitat they create. 
...
Oyster beds also provides filtration services as *O. lurida* and the suite of other organisms that recruit to oyster habitat (i.e. mussels, tunicates, scallops, and sponges) are filter-feeders. 
Suspended phytoplankton, bacteria, algae, and sediments are removed from the water column by the filter feeders, foodstuff digested, and unused matter is deposited in the benthos thus increasing water clarity [@Newell2004b; @Grizzle2008] useful to benthic primary producers, like seagrasses [@Peterson1999]. 

Settlers of European descent commercialized *O. lurida* harvests in the early 1800s in San Francisco Bay, CA [@Conte1982] and subsequently followed a common fishery collapse pattern [Kirby2004] of overfishing, non-nati. (Work on this sentence to introduce non-native introduction, pollution and sedimentation)
...
The population influx to California because of the gold rush starting in 1849 which led to destructive fishing of *O.lurida* (Beattie, McMillin & Wiegardt 1982 in Kirby 2004). 
By 1850 *O. lurida* populations in San Francisco Bay no longer produced adequate amounts of oysters, so the market then relyed on *O. lurida* harvested from more northern esturaries up to Washington State up until 1869 [@Kirby2004; more!], when the transcontinental Central Pacific Railroad was completed [@Conte1982]. 
With the new railroad came shipments of Eastern oysters (*Crassostrea virginica*) to California that were introduced to the San Francisco Bay and accounted for about 80% of the market in the late 1800s and early 1900s [@Conte1982].


The start of the gold rush in 1849(or 48? in Conte & Dupuy) led to overfishing *O. lurida* in San Francsico (Beattie, McMillin & Wiegardt 1982 in Kirby 2004) and shipments of *O. lurida* from estuaries subsequently up the coast [@Kirby2004].
