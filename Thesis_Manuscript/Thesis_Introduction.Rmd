...
The extreme reduction of native *O. lurida* abundances is coupled with the loss of estuarine habitat structure, and water filtration.
...
@Gray2018 expanded on this work and determined the filtration rates (L/hr/g DTW) of *O. lurida* and *C. gigas* under ranges of temperature, salinity, Total Particulate Matter (TPM), and Organic Content (OC) in laboratory and in situ experiments using the biodeposition method [@Hawkins1996].
These studies lay an important groundwork for previously understudied *O. lurida* habitat, but many bivalve filtration studies call for the need to transition to in situ whole-habitat measurements [@Grizzle2018; more]
