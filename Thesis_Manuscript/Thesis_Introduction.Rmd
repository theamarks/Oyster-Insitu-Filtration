...
Although @Gray2018 used ambient se water from Yaquina Bay in their in situ experiment across seasons, seston also changes spatially and temporally from tides, wind, bathometry, and proximety to benthic organisms [@Navarro1995; @Muschenheim1987; @Ashley1988; @Moody2020a), limiting their findings to bays with similar seston profiles.  
...
This illustrates bivalve's highly variable feeding responses to natural conditions and that filtration estimates need to be made from measurements that incorporate a habitat's unique biological and physical condidtions.
