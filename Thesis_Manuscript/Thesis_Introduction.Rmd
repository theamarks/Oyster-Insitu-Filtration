...
*O. lurida* was quickly overfished following the massive populaiton influx to California during the Gold Rush started in 1848 (Beattie, McMillin & Wiegardt 1982 in Kirby 2004). 

The fishery along the west coast subsequently followed a linear collapse pattern radiating out from San Francisco Bay [Kirby2004].


The population influx to California because of the gold rush starting in 1848 which led to destructive fishing of *O.lurida* (Beattie, McMillin & Wiegardt 1982 in Kirby 2004). 
