...
Suspended phytoplankton, bacteria, algae, and sediments are removed from the water column by the invertebrates, foodstuff digested, and unused matter is deposited in the benthos [@Baird1989] thus increasing water clarity [@Newell2004b; @Grizzle2008] useful to benthic primary producers, like seagrasses [@Peterson1999]. 

Settlers of European descent commercialized *O. lurida* harvests in the early 1800s in San Francisco Bay, CA [@Conte1982] and the fishery along the west coast subsequently followed a linear collapse pattern [Kirby2004] of overfishing, non-nati. (Work on this sentence to introduce non-native introduction, pollution and sedimentation)
