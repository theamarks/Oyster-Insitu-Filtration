...
Lastly, seston removal via bivalve filter feeding increases water clarity [@Newell2004b; @Grizzle2008; @Grizzle2018] thus the amount of photosynthetically available radiation reaching benthic primary producers like seagrasses [@Peterson1999] and microalgae [@Newell2002].

The capacity of *O. lurida*'s filtration functions was compromised when *O. lurida* populations were decimated by destructive fishing practices [@Kirby2004], introduction of non-native species [@Bonnot1935], pollution, and excessive sedimentation [@Gilbert1917; @Lotze2006; @Nelson1909] in the late 1800s and early 1900s.
...
@Gray2018 determined the clearance rates (Lhr^-1^g^-1^ DTW) of *O. lurida* and *C. gigas* under a range of laboratory and seasonal in situ conditions using the biodeposition method [@Hawkins1996].
...
These non-oyster filter-feeders that occupy oyster habitat have species-specific feeding behavior [@Møhlenberg1979; @Riisgard1988; @Riisgard2001; @Cranford2011; Gray2016; @Gedan2014], and the regional composition of this filter-feeding guild is likely to change along the NAPC, consequently creating unique filtration signatures for different *O. lurida* habitat and *C. gigas* aquaculture locations.
In addition, clearance rates defined by biomass (DTW) are not particularly useful in assessing wheather restored *O. lurida* habitat is also restoring filtration functions; restoration practitioners are hesitant to sacrifice bivalves to measure biomass directly.
