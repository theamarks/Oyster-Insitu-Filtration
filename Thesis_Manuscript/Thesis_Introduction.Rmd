...
Overfishing in concert with destructive fishing practices [@Kirby2004], introduction of non-native species [@Bonnot1935], pollution, and excessive sedimentation [@Gilbert1917; @Lotze2006; @Nelson1909] have reduced *O. lurida* populations to less than 10% of historical abundances in parts of the Pacific Northwest, and to less than 1% in the rest of its geographic distribution [@Beck2011; @ZuErmgassen2012].
...
@ZuErmgassen2013c used the decline in algal concentrations to calculate filtration rates (L/hr/g dry tissue weight) of *O. lurida* and *C. gigas* over a range of temperatures and oyster sizes in a laboratory.
@Gray2018 expanded on this work and determined the filtration rates (L/hr/g DTW) of *O. lurida* and *C. gigas* under ranges of temperature, salinity, Total Particulate Matter (TPM), and Organic Content (OC) in laboratory and in situ experiments using the biodeposition method [@Hawkins1996] in Yaquin Bay, Oregon.
These studies lay the foundation for estimating filtraiton capacity, however oyster-specific models do not account for the non-oyster, filter-feeding guild residing among oysters that differcially affect the overall filtration capacity [@Grizzle2018; @Grizzle2008; @Byers2014; @Gedan2014] (Olympia specific citations about invert community on restored habitats?)
The community composition of filter-feeders living on oyster habitat may change regionally or locally depending on species' distrubutions, environmental tolerances, and the establishment of non-native species.
...
Moreover, various filter-feeding taxa preferencially select for specific particle sizes [@Gedan2014; @Gray2016] depending on feeding physiology [@Elsey1935], leading to possible resource partitioning competition that effects the net filtration [@Byers2014].

This suggests that filtraiton rates among *O. lurida* habitats, even with comperable environmental conditions, may have unique filtration rates. 


* Different species - different overall filtration
  + Species-specific feeding behvior - [@Møhlenberg1979; @Riisgard1988; @Riisgard2001; Cranford2011]
    - can vary depending on spatial and temporal environmental conditions [@Moody2020a; Cranford1999] (citations in @Gray2018). 
  + Resource partitioning and/or competition - i.e. particle size [@Gedan2014; @Gray2016]
  + Predator effects on filtration [@Byers2014]

This suggests that applying *O. lurida* specific models to estimate *O. lurida* habitat filtraiton capacity 

### in situ environmental conditions that affect filtraiton
