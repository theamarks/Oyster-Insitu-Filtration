...
Laboratory studies can not account for the myrid of interacting environmental conditions that potentially effect the filtraiton capacity of a specific oyster bed [@Gray2018 cites Cranford and Hill 1999; @Grizzle2008; @Cranford2011]. --> Reword to something along the lines of needing to "move beyond labratory based oyster-only feeding rates to more ecologically realistic field stdies of how oyster reefs affect ecosystem processes (Grizzle et al. 2018 quote, includes list of citations)
