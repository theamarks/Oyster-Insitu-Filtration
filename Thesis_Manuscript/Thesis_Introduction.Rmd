...
Although @Gray2018 measured *O. lurida* and *C. gigas* feeding responses to seston quality and quantity (TSS and OC), the authors used laboratory reared phytoplankton (*Isochrysis galbana*) and Kaolin powder (Sigma-Aldrich®) to simulate changes in seston. 
...
Natural seston is composed of phytoplankton, zooplankton, detritus, bacteria, and inorganic sediments [@Trottet2008; @Lehane2006; @Newell1989] which changes spatially and temporally from tides, wind, bathometry, and proximety to benthic organisms [@Navarro1995; @Muschenheim1987; @Ashley1988; @Moody2020a). 
