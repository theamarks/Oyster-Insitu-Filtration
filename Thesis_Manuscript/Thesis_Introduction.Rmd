...
The complex biolgical and physical characteristics of *O. lurida* habitat highlight the need for in situ, whole-habitat filtration measurements [@Grizzle2008; @Grizzle2018; @Gedan2014; @Byers2014] specific to the habitat.
...
2) Measurements have an automatic averaging/agregate of individual bivalve feeding variation with a higher precision than filtration rates derived from individuals (check these: Cranford 1998, Inglesias et al 1998).
...
The quantity, particle size, and organic content (OC) of seston avilable to filter-feeders can effect filter-feeders' feeding behavior [@Gray2018; @Gray2019; @Gray2016; @Cranford1999; check Velasco2005; Moody2020?].
...
The motivation of this study is to determine the first ecologiacally and environmentally realistic clearance rates of restored *O. lurida* habitat and *C. gigas* aquaculture in California.
...
Higher organic content means a higher proportion of digestable food, which increases clearance rates (@Gray2018). [read Bayne et al. 1989; Barillé et al. 1997; Hawkins et al. 1998a; Bayne 2002; Ward and Shumway 2004)]. 
