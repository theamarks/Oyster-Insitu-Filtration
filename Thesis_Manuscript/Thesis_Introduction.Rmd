...
*O. lurida* and the bivalves recruited to oyster habitat are suspension feeders that remove particulate matter (seston) from the water column and deposit mucus-bound feces and pseudofeces (i.e. biodeposits) on the sediment surface [@Baird1989; @Dame1999; @Kellogg2013], consituting a critical ecosystem function. 
Most of the seston particulate organic matter (hensforth POM) is ingested by bivalves for growth and maintence.
Nutrients incorporated into bivalve shells can be sequestration long-term [@Kellogg2013] when burried in sediments [@Hu2011], and likely serve as a sink for anthropogenically produced nutrients [@Martinetto2006; @Carmichael2012].
