...
The conglomerate of living and dead shells creates complex habitat for a multitude of invertebrates, juvenile fishes and feeding habitat for birds and larger fishes [@Coen2007; @Peterson2003], and is thought to provide protection against shoreline erosion by diminishing wave energy in low energy environments like esturaries and bays [@Meyer1997; @Piazza2005; @Scyphers2011].
Indegenous peoples along the coast often lived close to these productive *O. lurida* beds, where middens indicate *O. lurida* was abundant and a substancial component of indegenous peoples' diets [@Merlin1977; @Elsasser1966; @Barner1981; @Kidd1967; @Nelson1909] as early as 3,500 years ago [@Gifford1916].
...
Overfishing in concert with destructive fishing practices [@Kirby2004], introduction of non-native species [@Bonnot1935], pollution, and exsessive sedimentaion [@Hopkins1931; @Lotze2006; @Nelson1909] have reduced *O. lurida* populations to less than 90% of historical abundances in parts of the Pacific Northwest, and to less than 99% in the rest of its geographic distribution [@Beck2011; @ZuErmgassen2012]. (reduced populations and inhibit pop recovery perhaps, could include more citations from Ruesink 2005, Lotze 2006, Jackson 2001)
...
In turn, the market transitioned to imparting *O. lurida* from esturaries up to Washington State until 1869 [@Kirby2004; more!], when the transcontinental Central Pacific Railroad was completed [@Conte1982].
...
Simultaneously, San Francisco Bay intertidal habitats were smothered by an estimated 876 million cubic meters of sediment washed into the bay from hydraulic gold mining in the Siera Nevada mountains [@Gilbert1917]. 
...
*C. gigas* now accounts for the overwhelming majority of commercial oyster harvest on the North American west coast (need citation), and has established ferral populations outside of aquaculture operations in the Salish Sea [@Quayle1988;], Willipa Bay, WA [@Kincaid1968], and Southern California [@Crooks2015a; @Polson2009; @Tronske2018].

### Loss of Ecosystem Services

The extreme reduction of native *O. lurida* abundances is coupled with the loss of important complex habitat, adjacent shoreline stablization, and water filtration functions.
Restoring this suite of ecosystem functions is part of the impetus behind native *O. lurida* restoration efforts along the west coast [@Dinnel2009; @Henderson2015b; @Latta2015; @Wasson2015; Zacherl2015a] (Ridlon2020?). 
...
First, *O. lurida* has a relatively small mean size, adults range from 15-45mm in length (find real # and citation), and body size is positively related to filtration rate (citations).
...
Third, most west coast bay and estuaries where *O. lurida* resides have low average residence times [citations in zu Ermgassen 2013], thus the water quality and phytoplankton community are predomently oceanic influenced [@ZuErmgassen2013c].

### Other Filtration Factors

While these factors may restrict *O. lurida*'s water filtration capacity, it is also necessary to consider the following factors when thinking about the filtraiton capacity of *O. lurida* habitat:
...
2) Environmental conditions like temperature [@Gray2018; @ZuErmgassen2013c], seston organic content [@Gray2018; @Kreeger2001], salinity [@Gray2018], and water velocity [@Grizzle1992; @Luckenbach1999a] are all known to affect bivalve filtration rates, are unique to each water body, and again could contribute to a unique filtration signature.
3) *O. lurida* habitat may have stronger influence over water quality in back reaches of bays where the residence time can be substancially longer than the bay's average.
4) Oyster culture operations raising non-native *C. gigas* are present in many west coast bays, and should be considered when estimating the bay-wide filtration services provided by oyster habiat.
*C. gigas* is a faster growing and larger oyster than *O. lurida* with a higher filtration rate [@Bougrier1995; @ZuErmgassen2013c; @Gray2018; @Gray2019] that is shown to decrease chlrophyll concentrations in Willipa Bay, WA [@Wheat2013].
...
@ZuErmgassen2013c calculated filtration rates (L/hr/g dry tissue weight) of *O. lurida* and *C. gigas* over a range of temperatures and oyster sizes in the labratory. 
@Gray2018 expanded on the work by @ZuErmgassen2013c and deterimined the filtration rates (L/hr/g DTW) of *O. lurida* and *C. gigas* under a range of temperature, salinity, Total Particulate Matter (TPM), and Organic Conent (OC). Labratory and in situ trials were included in this study using the biodeposition method to calculate filtration. 
...
Thus, estimating the filtration capacity of restored *O. lurida* habitat with these filtration models has limited application. (and may need field verification for other regional locations)

### Need for in situ Study

In situ studies that measure the filtration of the entire *O. lurida* habtiat community in complex environmental conditions are needed to augment previous labratory and in situ single species studies. 
Laboratory studies can not account for the myrid of environmental conditions interacting that may effect the filtraiton capacity of a specific oyster bed [@Gray2018 cites Cranford and Hill 1999; @Grizzle2008; @Cranford2011]
Species-specific feeding behavior is well documented and not homogenous (@Gray2018 cites many works). 
Texture of habitat leads to varied hydrodynamics and mixing (Harsh & Luckenback 1999) that can effect envirionmental that mediate filtraiton.
...
Water dynamics in shallow esturaries often mixes water column "eliminatting stratification of chlorophyll (Holligan et al. 1984 cited in @Judge1993).
...
Labratory studies often don't include oysters not feeding, closed valves, resulting in artifically high filtraiton rates [@Gray2018; @Harsh1999], and may partly explain why many field studies find lower FR than labortory studies [@Gray2018 cited Newell 2005, @Grizzle2008, @Cranford2011].
In situ studies may not be able to produce the sophisticated models based on manipulated variables, but can record the range of Filtraiton capacity of a specific restoration or aquaculture operation within its complex environment.
