...
The models from these studies provide important insights into *O. lurida* and *C. gigas* individual's feeding responses to specific conditions (temperature, salinity, Total Suspended Solids (TSS), and Organic Content (OC)) but are unable to fully replicate conditions of the natural environment [@Cranford2011] where feeding activity is more variable than laboratory conditions [@Newell2005; more citations].
...
Different bivalve filter-feeders have specific feeding behavior [@Møhlenberg1979; @Riisgard1988; @Riisgard2001; @Cranford2011] that can varies with spatial and temporal environmental conditions [@Moody2020a; @Cranford1999].
The composition of this filter-feeding guild is likely to vary regionally, in turn affecting the filtration signature of specific *O. lurid* habitat.
