...
@Gray2018 expanded on this work and deterimined the filtration rates (L/hr/g DTW) of *O. lurida* and *C. gigas* under ranges of temperature, salinity, Total Particulate Matter (TPM), and Organic Conent (OC). Labratory and in situ trials were included in this study using the biodeposition method to calculate filtration. 
...
Laboratory studies can not account for the myrid of interacting environmental conditions that potentially effect the filtraiton capacity of a specific oyster bed [@Gray2018 cites Cranford and Hill 1999; @Grizzle2008; @Cranford2011].
First, species-specific feeding behavior is well documented and can vary depending on local environmental conditions (@Gray2018 cites many works; @Møhlenberg1979; @Riisgard1988; @Riisgard2001). 
