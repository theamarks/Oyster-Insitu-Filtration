...
Thus, estimating the filtration capacity of restored *O. lurida* habitat with these filtration models has limited application.
...
Texture of oyster habitat leads to varied hydrodynamics and mixing (Harsh & Luckenback 1999).
...
Labratory studies often don't include oysters not feeding, closed valves, resulting in artifically high filtraiton rates [@Gray2018; @Harsh1999].
