...
@ZuErmgassen2013c used the decline in algal concentrations to calculate clearance rates (L/hr/g dry tissue weight) of *O. lurida* and *C. gigas* over a range of laboratory conditions.
@Gray2018 expanded on this work and determined the clearance rates (L/hr/g DTW) of *O. lurida* and *C. gigas* under a range of  laboratory and in situ conditions using the biodeposition method [@Hawkins1996].
The models from these studies provide important insights into *O. lurida* and *C. gigas* individual's feeding responses to specific conditions (temperature, salinity, Total Suspended Solids (TSS), and Organic Content (OC)) but are unable to fully replicate conditions of the natural environment/habitat [@Cranford2011].
First, non-oyster filter-feeders living in the oyster habitat contribute to the overall filtration capacity of the habitat [@Grizzle2018; @Grizzle2008; @Byers2014; @Gedan2014].
Filter-feeders have species-specific feeding behavior [@Møhlenberg1979; @Riisgard1988; @Riisgard2001; @Cranford2011; Gray2016; @Gedan2014] affected by loacl and seasonal environmental conditions [@Moody2020a; @Cranford1999].
Moreover, the composition of the filer-feeding guild is likely to change across *O. lurida*'s distrubution leading one to expect specific *O. lurida* beds to have a wide range of filtration functionality.


Second, water flow dynamics in the field are highly variable due to the interaction of tidal cycles and the physical characteristics of bays and estuaries (citations needed. @Judge1992).
