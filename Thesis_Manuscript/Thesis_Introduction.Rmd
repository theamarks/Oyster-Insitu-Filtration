...
Studies that exclude individuals that are not filtering (closed valves) artificially inflate filtration models, overestimate filtration when expanded to the population level [@Cranford2011; @Luckenbach1999]; this may partly explain why many field studies find lower filtration rates than laboratory studies [@Gray2018 cited Newell 2005; @Grizzle2008; @Cranford2011]; 
Lastly, bivalve feeding responses to natural water flow dynamics along with spatial and seasonal changes to seston composition are inherently included in whole-habitat in situ measurements. 
