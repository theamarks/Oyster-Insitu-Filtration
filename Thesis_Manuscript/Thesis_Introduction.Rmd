...
*O. lurida* and many of the bivalves that recruit to the oyster habitat are suspension feeders that remove organic and inorganic particles from the water column (seston) and deposit unused material in the benthos [@Baird1989; @Dame1999]. 
This water column to benthos connection is an important ecosystem pathway that increases water clarity [@Newell2004b; @Grizzle2008; @Grizzle2018] and enriches benthic sediments [@Kellogg2013; @Newell2002] useful to benthic primary producers like seagrasses [@Peterson1999] and microphytobenthos [@Newell2002].
