...
While the direct effects of water velocity on bivalve filter-feeding is unclear (@Grizzle1992; more), water depth and velocity affect water column mixing, thus food availability (and quality) for benthic filter-feeders (Monismith et al 1990 in Harsh & Luckenbach 1999) (Holligan et al. 1984 cited in Judge et al. 1993).
...
Natural seston is composed of phytoplankton, zooplankton, detritus, bacteria, and inorganic sediments [@Trottet2008; @Lehane2006; @Newell1989] which changes spatially and temporally from tides, wind, bathometry, and proximety to benthic organisms [@Navarro1995; @Muschenheim1987 Ashley & Grizzle 1988). 
