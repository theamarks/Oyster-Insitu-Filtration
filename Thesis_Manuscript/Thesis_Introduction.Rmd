...
These studies lay the foundation for estimating filtration capacity, however oyster-specific models do not account for the non-oyster, filter-feeding guild residing among oysters that differential effect the net filtration capacity [@Grizzle2018; @Grizzle2008; @Byers2014; @Gedan2014] (Olympia specific citations about invert community on restored habitats? Zacherl?)
The community composition of filter-feeders living on oyster habitat may change regionally or locally depending on species' distributions, environmental tolerances, and the establishment of non-native species.
...
This suggests that filtration rates among *O. lurida* habitats, even with comparable environmental conditions, may have unique filtration rates. 


* Different species - different overall filtration
  + Species-specific feeding behavior - [@Møhlenberg1979; @Riisgard1988; @Riisgard2001; Cranford2011]
