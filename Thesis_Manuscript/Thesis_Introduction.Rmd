...
* Could introduce whole-habitat filtration first, then go into Oly/West coast
...
The models from this study provides important insights into *O. lurida* and *C. gigas* individual's feeding responses to specific conditions (temperature, salinity, turbidity, chlorophyll $\alpha$, Total Suspended Solids (TSS), and Organic Content (OC)) but may not be appropriate for estimating whole-habitat filtration in the field [@Cranford2011; @Grizzle2018; Velasco2005; Newell2005].
*Whole-habitat introduction here? Then following environmental things are in support of whole-habitat? Introduce sooner if more important.*
...
Whole-habitat filtration measurements have several distinct advantages over single-species models.
1) "require fewer measurements to achieve high level of precision due ot "build-in" averaging of individual variations (Cranford 1998 Inglesias et al 1998)
2) account for filter-feeding guild
2) Spatial and seasonal changes in seston composition
3) Incorporates natural flow dynamics 

In addition to the inculding the entire filter-feeding guild within measurements, seston, which filter-feeders consume, changes spatially and seasonally.
Seston, is a complex assemblage of phytoplankton [@Navarro1995], zooplankton [@Lehane2006; @Trottet2008], macroalgae detritus [@Page1997; @Kwak1997; @Gilbane2006], bacteria [@Newell1989], and inorganic sediments [@Wilson-Ormond1997; @Gray2018] that is affected by tides, wind, bathometry, and proximety to benthic organisms [@Navarro1995; @Muschenheim1987; @Ashley1988; @Moody2020a).
The quantity, particle size, and organic content (OC) of seston avilable to filter-feeders can effect filter-feeders' feeding behavior [@Gray2018; @Gray2019; @Gray2016; Velasco2005; @Cranford1999]



Second, water flow dynamics in the field are highly variable [@Wilson-Ormond1997] due to the interaction of tidal cycles and the physical characteristics of bays and estuaries (citations needed. @Judge1992).
While the direct effects of water velocity on bivalve filter-feeding is unclear (@Grizzle1992; more), water depth and velocity affect water column mixing, thus food availability (and quality) for benthic filter-feeders (Monismith et al 1990 in Harsh & Luckenbach 1999 BAD) (Holligan et al. 1984 cited in Judge et al. 1993).
Third, the quality and quantity of food/seston is well documented to effect bivalve-filtraiton [@Gray2018; Moody2020a; more] and can change among tidal cycle and seasonally (need citations).
Although @Gray2018 measured *O. lurida* and *C. gigas* feeding responses to seston quality and quantity (TSS and OC), the authors used laboratory reared phytoplankton (*Isochrysis galbana*) and Kaolin powder (Sigma-Aldrich®) to simulate changes in seston (ONLY FOR lab portion, insitu model was found to be best (natural water)).
...
Natural seston is composed of phytoplankton [@Navarro1995], zooplankton [@Lehane2006; @Trottet2008], macroalgae detritus [@Page1997; @Kwak1997; @Gilbane2006], bacteria [@Newell1989], and inorganic sediments [@Wilson-Ormond1997; @Gray2018] which changes spatially and temporally from tides, wind, bathometry, and proximety to benthic organisms [@Navarro1995; @Muschenheim1987; @Ashley1988; @Moody2020a). 

leading to specific *O. lurida* beds a wide range of filtration functionality.


The models from these studies provide important insights into *O. lurida* and *C. gigas* individual's feeding responses to specific conditions (temperature, salinity, Total Suspended Solids (TSS), and Organic Content (OC)) but are unable to fully replicate conditions of the natural environment/habitat [@Cranford2011] where feeding activity is more variable [@Newell2005] and different from laboratory measurements [@Gray2019; @Gray2018; @Velasco2005] (Maybe don't need last part of sentence).
Filter-feeders have species-specific feeding behavior [@Møhlenberg1979; @Riisgard1988; @Riisgard2001; @Cranford2011; Gray2016; @Gedan2014] affected by local and seasonal environmental conditions [@Moody2020a; @Cranford1999].
along with the presence of predators [@Byers2014] <-- save for discussion?
...
The composition of this filter-feeding guild is likely to vary regionally, affecting the filtration signature of specific *O. lurid* habitat because each species has specific feeding behavior [@Møhlenberg1979; @Riisgard1988; @Riisgard2001; @Cranford2011; Gray2016; @Gedan2014] that can variy with spatial and temporal environmental conditions [@Moody2020a; @Cranford1999].


### in situ environmental conditions that affect filtration

A less common way to measure filtration is in situ whole-habitat measurements, only a few studies have used these methods [@Grizzle2006; @Grizzle2008; @Grizzle2018; @Milbrandt2015 (more in Grizzle2018)] compared to the myrid of labroratory studies.
In situ whole-habitat measurements also encompass many realistic physical and biological conditions known to affect bivalve filtration.
...
Studies often report individuals not feeding while others are. Studies often discount/remove non-filtering individuals from their calculations, which presents a problem when scaling to habitat filtraiton estimates [@Luckenbach1999. 
