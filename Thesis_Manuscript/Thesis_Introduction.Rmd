...
Thus, estimating the filtration capacity of restored *O. lurida* habitat with these filtration models may have limited application.

will not include the multitude of other filter-feeders contributing (Grizzle citation?), and will not represent the full range of environmental factors effecting filter-feeding (citations).
