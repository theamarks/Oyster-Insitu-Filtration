...
The shells of living and dead oysters provide habitat for invertebrates across trophic levels [@Kimbro2006; @Ramsey2012; @Rodney2006], nursery and refuge habitat for fishes [@Coen2007; @Peterson2003; @Stunz2010], and feeding habitat for birds [@Galtsoff1929; Boyer et al. 2016 waiting for ILL copy].
*O. lurida* and many of the bivalves that recruit to the oyster habitat are suspension feeders that remove particulate matter (seston) from the water column and deposit mucus-bound feces and pseudofeces (i.e. biodeposits) on the sediment surface [@Baird1989; @Dame1999; @Kellogg2013], consituting an important ecosystem function. 
Most of the seston particulate organic matter (hensforth POM) is ingested by the bivalves for growth and maintence; the remaining POM and seston particualte inorganic matter (hensforth PIM) constitutes the biodeposits.
Nutrients incorporated into bivalve shells is a long-term sequestration pathway [@Kellogg2013] when burried in sediments [@Hu2011].
