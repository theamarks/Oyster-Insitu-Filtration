...
@Gray2018 expanded on this work and determined the filtration rates (L/hr/g DTW) of *O. lurida* and *C. gigas* under a range of  laboratory and in situ conditions using the biodeposition method [@Hawkins1996].
The models from these controlled studies provide important insights into *O. lurida* and *C. gigas* individual's feeding responses to specific conditions (temperature, salinity, Total Suspended Solids (TSS), and Organic Content (OC)) but are unable to fully replicate conditions of the natural environment [@Cranford2011] where feeding activity is more variable than laboratory conditions [@Newell2005; more citations]
First, non-oyster filter-feedings living among the oysters differential effect the net filtration capacity [@Grizzle2018; @Grizzle2008; @Byers2014; @Gedan2014].
Different bivalve filter-feeders have specific feeding behavior [@Møhlenberg1979; @Riisgard1988; @Riisgard2001; @Cranford2011] that can vary from spatial and temporal environmental conditions [@Moody2020a; @Cranford1999].
The composition of this filter-feeding guild is likely to vary regionally depending on species' distributions and environmental tolerances, in turn affecting the filtration signature of specific *O. lurid* habitat.
Add species particle size selection differences here?
Second, water flow dynamics in the field are highly variable due to the interaction of tidal cycles and physical characteristics of estuaries (citations needed. @Judge1992).
...
Natural seston is composed of phytoplankton [@Navarro1995], zooplankton [@Lehane2006; @Trottet2008], macroalgae detritus [@Page1997; @Kwak1997; @Gilbane2006], bacteria [@Newell1989], and inorganic sediments [@Newell1989] which changes spatially and temporally from tides, wind, bathometry, and proximety to benthic organisms [@Navarro1995; @Muschenheim1987; @Ashley1988; @Moody2020a). 

Find CSUF emeritis prof papers on chl sources.
