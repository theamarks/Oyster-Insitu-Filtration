...
######################################################################
##CHange negative Chl values to zero (AM - 2020_11_4) - below detection limit
###################################################################### 
  # Changes HCR to 17,700 L/hr/m^2 this date still needs to be removed
  # one_file = neg_chl_to_zero(one_file)
...
###
```{r Sbs_Correction_Uncertainty, fig.height=5, fig.width=4, cache=TRUE, eval = FALSE}
######################################################################
