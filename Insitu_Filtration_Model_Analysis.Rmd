...
NPD_biomass_data_clean <- NPD_bivalve_biomass_data %>% 
...
NPD_bivalve_biomass_graph <- NPD_biomass_data_clean %>% 
...
# Remove negative DTW (doesn't make sense, probably processing error)
NPD_Posbiomass_data <- NPD_biomass_data_clean %>% 
...
NPD_Posbiomass_graph <- NPD_Posbiomass_data %>% 
  ...
  labs(x = "Shell length (mm)",
       y = "Dry Tissue Weight (g)",
       title = "Newport Deanza Bivalve Biomass",
       subtitle = "Positive DTW only") +
  theme_classic() +
  theme(strip.text = element_text(face = "italic"))

NPD_Posbiomass_graph
