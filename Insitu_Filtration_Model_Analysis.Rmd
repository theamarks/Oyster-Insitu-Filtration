...
```{r FR_ChlRmd_Filter, fig.height=5, fig.width=16, cache=TRUE}
...
```{r FR_ChlRmd_TPM_posFilter, fig.height=5, fig.width=16, cache=TRUE}
...
```{r, Filter by TPM filter only, fig.height=5, fig.width=16, cache=TRUE}
...
```{r , fig.height=5, fig.width=16, cache=TRUE}
...
### ***Filtration vs OC***
```{r FR vs OC, fig.height=5, fig.width=16, cache=TRUE}
...
```{r FRPos vs OC, fig.height=5, fig.width=16, cache=TRUE}
...
```{r LogChlRmdPos_OC, fig.height=5, fig.width=8, cache=TRUE}
...
### ***Temperature ***
```{r Filter_Temp, fig.height=10, fig.width=16, cache=TRUE, echo=FALSE}
...
### ***Filtration - Salinity***
```{r Filter_Salinity, fig.height=10, fig.width=16, cache=TRUE, echo=FALSE}
...
```{r Filter_Chl, fig.height=10, fig.width=16, cache=TRUE, echo=FALSE}
...
```{r Filter_Turbidity, fig.height=10, fig.width=16, cache=TRUE, echo=FALSE}
...
> Not significant. Almost. p-value: 0.080
...
> Not significant. Almost. p-value: 0.086
...
### ***TPM by OC***
```{r TPM_OC, fig.width=16, fig.height=10, cache=TRUE}
...
> significant predictor. p-value: 0.000
...
> R^2 0.72. p-value: 0.000. Slightly better fit than just x-axis transformation
...
### ***Linear model without outlier***
```{r, Log transform DTW & shell length***
```{r, fig.height=6, fig.width=6, cache=TRUE}
