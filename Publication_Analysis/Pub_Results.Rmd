...
# Oly_combo_DTW_SL$Site <- factor(Oly_combo_DTW_SL$Site, levels = c("Yaquina", "Deanza", "San Diego"))
...
Combo_Oly_shell_DTW_figure
 ...
 ggsave(Combo_Oly_shell_DTW_figure, 
        height=3.09, width=5, dpi = 600, 
        device = "png",
        filename = file.path("./Publication_Analysis/figures/", paste0("Oly_DTW_SL_allsites_",Sys.Date() ,".png")))
#fig.asp=0.618
